...
const MOCK_KPIS = [
  ...
  { id: 4, acronym: 'OPI',  name: 'Orphaned Processing Index',     type: 'sql',    page: 'publish',    enabled: true,  description: 'Processed videos unpublished for >30 days — stuck in pipeline' },
  { id: 5, acronym: 'TEU',  name: 'Time Efficiency of User',       type: 'sql',    page: 'team',       enabled: true,  description: 'Average gap (hours) between consecutive uploads per user' },
  ...
  { id: 14, acronym: 'PMI',  name: 'Performance Momentum Index',   type: 'sql',    page: 'executive',  enabled: true,  description: 'WoW impression growth rate per workspace' },
