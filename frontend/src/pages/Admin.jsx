...
const MOCK_KPIS = [
  ...
  { id: 10, acronym: 'HTHR', name: 'High-Throughput Hour Rate',    type: 'sql',    page: 'publish',    enabled: true,  description: 'Peak publishing time windows' },
  { id: 11, acronym: 'TSQI', name: 'Time-Series Quality Index',    type: 'sql',    page: 'publish',    enabled: true,  description: 'Temporal completeness score' },
  { id: 12, acronym: 'PIG',  name: 'Publish Intent Gap',           type: 'sql',    page: 'publish',    enabled: true,  description: 'PCR vs target gap per workspace' },
  { id: 13, acronym: 'AGV',  name: 'Audience Growth Velocity',     type: 'sql',    page: 'executive',  enabled: true,  description: 'Subscriber growth rate' },
  { id: 14, acronym: 'PMI',  name: 'Platform Mix Index',           type: 'sql',    page: 'publish',    enabled: true,  description: 'YouTube vs Instagram balance' },
  { id: 15, acronym: 'MCI',  name: 'Missing Completeness Index',   type: 'sql',    page: 'executive',  enabled: true,  description: 'Data quality: % missing fields' },
  { id: 16, acronym: 'DCDR', name: 'Date Completeness Delta Rate', type: 'sql',    page: 'executive',  enabled: true,  description: 'Rate of missing date fields' },
  { id: 17, acronym: 'CPDG', name: 'Content Pipeline Drop Gap',    type: 'python', page: 'publish',    enabled: true,  description: 'Drop between processing and publishing' },
